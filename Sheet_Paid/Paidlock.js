function onEdit(e) {
    try {
      var sheetId = '1k-NnU7YV7Em1rt56cK8_ySQIohMuOzGTaZVQVWnkI3o';
     ...
     // Lock the edited cell
      range.setDataValidation(null);
      range.setValue('Paid (Locked)').setBackground('#00FF00'); // Change background color to green
      range.protect().setDescription('Paid cell locked');
